            ...
            <footer style="background-color: #ECEFF1;">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-2" style="margin-left:10%">
                           <div class="" style="margin-top: 20%;">
                            ...
                            <h4 style="color: #002A5C;text-align:center;margin-top:20%;margin-bottom: 10%;">IUBAT ALUMNI</h4>

                            <p style="color: #002A5C;text-align:center;padding:15px;font-size: 15px;">WELCOME TO IUBAT UNIVERSITY AND YOU ENJOY YOUR TIME</p>
                        </div>
                        <div class="col-lg-2" style="margin-left:5%">
                            ...
                            <h4 style="color: #002A5C;text-align:center;margin-top:20%;margin-bottom: 10%;">USEFUL LINKS</h4>
                            <h5 style="color:#002A5C;text-align:center;padding:15px;font-size:15px;">IMAGE GALLERY</h5>
                             <h5 style="color: #002A5C;text-align:center;padding:15px;font-size: 15px;">IUBAT RESULT</h5>
                            <h5 style="color:#002A5C;text-align:center;padding:15px;font-size: 15px;"> IUBAT EDU</h5>
                        ...
                        <div class="col-lg-2" style="margin-left:5%">
                            ...
                            <h4 style="color: #002A5C;text-align:center;margin-top:20%;margin-bottom: 10%;">CONTACT US</h4>
                             
                            <h5 style="color: #002A5C;text-align:center;padding:15px;font-size: 15px;">HELP CENTER</h5>
                             <h5 style="color: #002A5C;text-align:center;padding:15px;font-size: 15px;">HELP CENTER</h5>
                        ...
                        <div class="col-lg-2" style="margin-left:5%">
                            ...
                            <h4 style="color: #002A5C;text-align:center;margin-top:20%;margin-bottom: 10%;">ADDRESS</h4>
                            <h5 style="color: #002A5C;text-align:center;padding:10px;font-size: 15px;line-height:30px;"><i class="fa fa-home mr-3"></i> IUBAT UNIVERSITY, UTTARA-1230,DHAKA,BD</h5>
                            <h5 style="color: #002A5C;text-align:center;padding:15px;font-size: 15px;"><i class="fa fa-envelope mr-3"></i> easylearn@gmail.com</h5>
                            <h5 style="color: #002A5C;text-align:center;padding:15px;font-size: 15px;"><i class="fa fa-phone mr-3"></i> + 88 017 51 337 061</h5>
                    ...
                    <hr />
                            ...
                            <h4>
                                <center>Copyright &copy; <?php echo date("Y");?> <i class="fa fa-heart" style="color: red;"></i>EasyLearn.com<i class="fa fa-heart" style="color: red;"></i></center>
                            </h4>
