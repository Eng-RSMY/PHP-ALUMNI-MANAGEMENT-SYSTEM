...
<label style="background-color: #00C0EF;color: #FFFFFF;padding:2%;text-align:center;width: 100%;font-size: 180%; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.4);">Registration For Event Manager</label>

<!--Registration page-->
<div class="" style="background-color: #FFFFFF;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.6);">
